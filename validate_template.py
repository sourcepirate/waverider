...
class TestTemplateStructure:
    ...
    def __init__(self):
        ...
        self.project_template_dir = os.path.join(
    ...
    def test_docker_files_content(self):
        ...
        dockerfile_path = os.path.join(
            self.template_dir, "{{ cookiecutter.project_slug }}/Dockerfile"
        )
        compose_path = os.path.join(
            self.template_dir, "{{ cookiecutter.project_slug }}/docker-compose.yml"
        )
