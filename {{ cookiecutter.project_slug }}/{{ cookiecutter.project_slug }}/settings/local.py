...
DATABASES = {
    'default': {
        ...
        'HOST': config('POSTGRES_HOST', default='db'), # Service name in docker-compose.yml
        'PORT': config('POSTGRES_PORT', default='{{ cookiecutter.postgresql_port }}'), # Internal port within docker network
    }
}
