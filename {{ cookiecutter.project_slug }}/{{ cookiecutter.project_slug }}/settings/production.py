...
CACHE_URL = config(
    "CACHE_URL", default="redis://redis:6379/2"
)  # Default assumes redis service name
CACHES = {
    "default": {
...
SECRET_KEY = config(
    "DJANGO_SECRET_KEY", default="{{ cookiecutter.django_secret_key }}"
...
ALLOWED_HOSTS = config(
    "DJANGO_ALLOWED_HOSTS", cast=Csv(), default=[]
)  # e.g., ".yourdomain.com"
...
try:
    ...
    security_middleware_index = _MIDDLEWARE.index(
